...
export default auth((req) => {
  ...
  console.log({ isLoggedIn, path: nextUrl.pathname, role });
  ...
  // Redirigir a /dashboard o /admin dependiendo del rol si el usuario está logueado y trata de acceder a rutas de autenticación
